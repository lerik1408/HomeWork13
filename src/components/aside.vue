...
<aside class="aside" :class="{'aside--active': s}">
    ...
    <nav class="menu">
        ...
        <router-link to="/messenger" class="menu__item" v-bind:class="{ 'menu__item--active': active.messenger }">
        ...
        <router-link to="#" class="menu__item">
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.9792 4.34873C15.7576 4.34873 16.388 3.72254 16.388 2.94421V1.47277C16.388 0.693732 15.7576 0.0654297 14.9792 0.0654297C14.2016 0.0654297 13.5733 0.693732 13.5733 1.47277V2.94421C13.5733 3.72254 14.2016 4.34873 14.9792 4.34873Z" fill="white" />
                <path d="M19.9796 2.50064H17.1473V3.21699C17.1473 4.39752 16.1872 5.3604 15.0039 5.3604C13.8191 5.3604 12.8619 4.39752 12.8619 3.21699V2.50064H7.14447V3.21699C7.14447 4.39752 6.18441 5.3604 5.00106 5.3604C3.81771 5.3604 2.85905 4.39682 2.85905 3.21629V2.50064L1.59539e-09 2.46472V20.3572H1.42918H18.5736L20 20.353L19.9796 2.50064ZM18.5736 18.9323H1.42918V7.5017H18.5736V18.9323Z" fill="white" />
                <path d="M4.97838 4.34873C5.75671 4.34873 6.38572 3.72254 6.38572 2.94421V1.47277C6.38572 0.693732 5.75742 0.0654297 4.97838 0.0654297C4.20145 0.0654297 3.57245 0.693732 3.57245 1.47277V2.94421C3.57245 3.72254 4.20145 4.34873 4.97838 4.34873Z" fill="white"/>
                <path d="M9.39983 9.03589H7.14935V11.0229H9.39983V9.03589Z" fill="white" />
                <path d="M5.87792 9.03589H3.62744V11.0229H5.87792V9.03589Z" fill="white"/>
                <path d="M13.0428 9.03589H10.7895V11.0229H13.0428V9.03589Z" fill="white"/>
                <path d="M16.416 9.03589H14.1655V11.0229H16.416V9.03589Z" fill="white"/>
                <path d="M9.39983 12.3356H7.14935V14.3212H9.39983V12.3356Z" fill="white"/>
                <path d="M13.0428 12.3356H10.7895V14.3212H13.0428V12.3356Z" fill="white"/>
                <path d="M16.416 12.3356H14.1655V14.3212H16.416V12.3356Z" fill="white"/>
                <path d="M9.39983 15.7013H7.14935V17.6869H9.39983V15.7013Z" fill="white"/>
                <path d="M5.82152 12.3356H3.57245V14.3212H5.82152V12.3356Z" fill="white"/>
                <path d="M5.82152 15.7013H3.57245V17.6869H5.82152V15.7013Z" fill="white"/>
                <path d="M13.0428 15.7013H10.7895V17.6869H13.0428V15.7013Z" fill="white"/>
                <path d="M16.416 15.7013H14.1655V17.6869H16.416V15.7013Z" fill="white"/>
            </svg>
        </router-link>
    </nav>
</aside>
